package com.example.sahithikilaru.blufic;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String APP_NAME = "Blufic";
    ...
    private static final int DISCOVER_DURATION = 180;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == DISCOVER_DURATION && requestCode == REQUEST_BLU) {
            ...
            if (appsList.size() > 0) {
                ...
                if (!found) {
                    Toast.makeText(this, "Bluetooth hasn't been found",
